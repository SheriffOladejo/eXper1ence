...
class _SettingsState extends State<Settings> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              GestureDetector(
                onTap: () async {
                  await showCountryDialog(context);
                },
                child: Container(
                  width: 200,
                  child: Row(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: Text("Settings", style: primaryTextStyle(16, Colors.white, FontWeight.bold),),
  ...
  Future<void> getCountries() async {
    ...
    var url = Uri.https(Constants.api_url, '/v1/countries/0/live/en');
  ...
  Future<void> getSports() async {
    ...
    sport_list.clear();
    var url = Uri.https(Constants.api_url, '/v1/sports/live/en');
    var response = await http.get(url, headers: {"Package":"KlUet6y43te8Jg6G9bkDxN36f9X9ZiTkm"});
    if(response.statusCode == 200){
      var json = jsonDecode(response.body.toString());
  ...
  Future showCountryDialog(BuildContext context) async {
  ...
  Future showSportDialog(BuildContext context) async {
    AlertDialog alert = AlertDialog(
      backgroundColor: HexColor("#0F324F"),
